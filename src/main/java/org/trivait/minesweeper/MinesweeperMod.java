...
public class MinesweeperMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        FabricLoader.getInstance().getModContainer("minesweeper").ifPresent(s ->
                ResourceManagerHelper.registerBuiltinResourcePack(Identifier.of("minesweeper", "minesweeper"), s, Text.translatable("resourcePack.minesweeper"), ResourcePackActivationType.NORMAL)
        );
    }
