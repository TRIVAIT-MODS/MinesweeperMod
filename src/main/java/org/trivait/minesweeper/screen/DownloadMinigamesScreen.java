...
public class DownloadMinigamesScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(Identifier.of("minesweeper", "textures/gui/minigames.png"), width/2-textureW/2, height/2-textureW/2-10, 0, 0, textureW, textureW, textureW, textureW);
