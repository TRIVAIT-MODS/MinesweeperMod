...
public class ScoreSelectWidget extends ClickableWidget {
    ...
    protected void renderWidget(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        ctx.drawTexture(RenderLayer::getGuiTextured, Identifier.of(MinesweeperMod.MOD_ID, "textures/gui/score.png"), getX() + 1, getY() + 1, 0, 0, width - 2, height - 2, width - 2, height - 2);
