...
public class TimeSelectWidget extends ClickableWidget {
    ...
    protected void renderWidget(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        ctx.drawTexture(RenderLayer::getGuiTextured, Identifier.of(MineSweeperMod.MOD_ID, "textures/gui/time.png"), getX() + 1, getY() + 1, 0, 0, width - 2, height - 2, width - 2, height - 2);
