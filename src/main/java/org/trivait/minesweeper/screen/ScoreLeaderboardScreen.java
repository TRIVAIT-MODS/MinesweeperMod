...
public class ScoreLeaderboardScreen extends Screen {
    ...
    protected void init() {
        ...
        }).tooltip(Tooltip.of(Text.translatable("leaderboard.mines").append(Text.literal("" + BoardCategory.S8x8.mines)))).dimensions(btnX, groupY, btnW, 20).build();
        ...
        this.c16x16Button = ButtonWidget.builder(Text.literal("16x16"), b -> {
            ...
            c26x18Button.active = true;
        }).tooltip(Tooltip.of(Text.translatable("leaderboard.mines").append(Text.literal("" + BoardCategory.S16x16.mines)))).dimensions(btnX, groupY + btnSpacing, btnW, 20).build();
        ...
        this.c26x18Button = ButtonWidget.builder(Text.literal("26x18"), b -> {
            ...
            c16x16Button.active = true;
            c8x8Button.active = true;
        }).tooltip(Tooltip.of(Text.translatable("leaderboard.mines").append(Text.literal("" + BoardCategory.S26x18.mines)))).dimensions(btnX, groupY + btnSpacing * 2, btnW, 20).build();
