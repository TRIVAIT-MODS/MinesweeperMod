...
public class MinesweeperScreen extends Screen {
    ...
    private class SmileyButtonWidget extends ClickableWidget {
        ...
        protected void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
            ...
            context.drawTexture(tex, ix, iy, 0, 0, iw, ih, iw, ih);
        }
            ...
            for (int xx = 0; xx < w; xx++) {
                ...
                if (c.revealed) {
                    if (c.mine && !won) {
                        ...
                        context.drawTexture(c.flagged && !alive ? TEX_FLAG : TEX_TNT_SIDE, ox, oy, 0, 0, texSizeAdjust, texSizeAdjust, texSizeAdjust, texSizeAdjust);
                    ...
                    int ox = cx - texSizeAdjust / 2, oy = cy - texSizeAdjust / 2;
                    context.drawTexture(!alive && !won && !c.mine ? TEX_BARRIER : TEX_FLAG, ox, oy, 0, 0, texSizeAdjust, texSizeAdjust, texSizeAdjust, texSizeAdjust);
                }
                context.getMatrices().pop();
            }
        }
