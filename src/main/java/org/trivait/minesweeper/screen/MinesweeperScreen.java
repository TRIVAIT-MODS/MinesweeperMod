            ...
            for (int xx = 0; xx < this.w; xx++) {
                ...
                if (c.revealed) {
                    ...
                    if (c.mine && !this.won) {
                        ...
                        context.drawTexture(TNT_SIDE, offsetX, offsetY, 0, 0, texSize, texSize, texSize, texSize);
                    }
                    // Число соседних мин
                ...
                // Флажки
                    ...
                    if (!this.alive) {
                        if (c.mine) {
                            ...
                            int offsetX = x + (this.cellSize - texSize) / 2;
                            int offsetY = y + (this.cellSize - texSize) / 2;
                            context.drawTexture(BARRIER, offsetX, offsetY, 0, 0, texSize, texSize, texSize, texSize);
                        }
                    } else {
                        int pole = 0xFF222222;
                        int flag = 0xFFFF0000;
