...
public class MinesweeperScreen extends Screen {
    ...
    private static final Identifier TEX_FLAG     = Identifier.of(MinesweeperMod.MOD_ID, "textures/gui/flag.png");
    ...
    protected void init() {
        ...
        if (gameMode == GameMode.DEFAULT) {
            ...
            if (board.w!=normalizedSetting.width()||board.h!=normalizedSetting.height()||board.mines!=normalizedSetting.mines()) {
                ...
                if (client != null) {
                    client.setScreen(new MinesweeperScreen(normalizedSetting, GameMode.DEFAULT));
                }
            }
        }
        ...
        if (gameMode == GameMode.DEFAULT) {
            ...
            TextIconButtonWidget configBtn = TextIconButtonWidget.builder(
                    Text.empty(),
                    (button) -> {
                        client.setScreen(AutoConfigClient.getConfigScreen(Config.class, this).get());
                    },
                    true
